...
import { ShieldCheck, Zap, BookOpen, AlertTriangle, ExternalLink, Terminal, Code2, Layers, RotateCcw, ArrowRight } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen text-neutral-100 font-sans selection:bg-blue-500/30 flex flex-col">
